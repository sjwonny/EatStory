...
<script type="text/javascript">
	function check(f){
		//var param = "id=" + encodeURIComponent(f.id.value) + "&pw" + encodeURIComponent(f.pw.value);
...
//			httpRequest.open("GET","/eatstory/ajax?name=" + name);
			httpRequest.open("POST","/eatstory/ajax");
